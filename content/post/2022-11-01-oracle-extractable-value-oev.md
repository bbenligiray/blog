...
Although our Airnode request–response and publish–subscribe protocols are designed to allow these kinds of novel oracle services to be built, we’re aware that data feeds are not going anywhere soon, and our [dAPIs](https://blog.benligiray.com/post/2022-03-31-dapis-apis-for-dapps/) primarily cater to DeFi projects that require traditional data feeds for this exact reason.
